        ...
        <Table className="min-w-full sm:min-w-[1000px] text-base text-gray-800 bg-[#E3F2FD] border border-gray-300">
         ...
         <TableHeader className="sticky top-0 bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
          <TableRow>
            ...
            <TableHead className="text-center text-white text-sm cursor-pointer"
             onClick={() => handleSortChange("requester")}>Requester</TableHead>
            <TableHead className="text-center text-white text-sm cursor-pointer"
             onClick={() => handleSortChange("college")}>College</TableHead>
            <TableHead className="text-center text-white text-sm cursor-pointer"
              onClick={() => handleSortChange("purpose")}>Purpose</TableHead>
            <TableHead className="text-center text-white text-sm cursor-pointer"
             onClick={() => handleSortChange("status")}>Status</TableHead>
            <TableHead className="text-center text-white text-sm cursor-pointer">
              Documents Requested</TableHead>
            <TableHead className="text-center text-white text-sm cursor-pointer">
              Remarks</TableHead>
            <TableHead className="text-center text-white text-sm cursor-pointer">
              Date Requested</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
                      ...
                      <Table>
                        <TableHeader>
                          <TableRow>
                            ...
                            <TableHead className="text-left">Pages</TableHead>
